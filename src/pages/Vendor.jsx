...
export default function Vendor() {
  ...
  const [form, setForm] = useState({ nama: '', jenis: 'HOTEL', kontak: '' });
  ...
  function openAdd() {
    setEditingId(null);
    setForm({ nama: '', jenis: 'HOTEL', kontak: '' });
    setFormError('');
    setShowForm(true);
  }
  ...
  function openEdit(v) {
    setEditingId(v.id);
    setForm({ nama: v.nama, jenis: v.jenis, kontak: v.kontak || '' });
    setFormError('');
    setShowForm(true);
  }
  ...
  async function handleSubmit(e) {
    ...
    setFormError('');
    if (!form.nama.trim()) {
      setFormError('Nama vendor wajib diisi.');
      return;
    }
    const payload = { nama: form.nama.trim(), jenis: form.jenis, kontak: form.kontak.trim() || null };
    setSubmitting(true);
